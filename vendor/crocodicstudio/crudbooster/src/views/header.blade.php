...
<header class="main-header">
    ...
    <!-- Logo -->
    <a style="text-transform: uppercase;font-size: 18px" href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo"><b>{{CRUDBooster::getSetting('appname')}}</b></a>
