<?php namespace App\Http\Controllers;
		...
		class ApiSearchSurveyController extends \crocodicstudio\crudbooster\controllers\ApiController {

		    function __construct() {    
				$this->table       = "agunan";        
				$this->permalink   = "search_survey";    
		    ...
		    public function hook_before(&$postdata) {
		       ...
		       $cek = DB::table('agunan')
		       ->where('id_surveyor',g('id_surveyor'))
