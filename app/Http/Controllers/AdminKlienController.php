...
class AdminKlienController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->form[] = ['label' => 'Telp', 'name' => 'telp', 'type' => 'number', 'validation' => 'required|numeric', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Alamat', 'name' => 'alamat', 'type' => 'textarea', 'validation' => 'required|string|min:5|max:5000', 'width' => 'col-sm-10', 'placeholder' => 'You can only enter the number only'];
