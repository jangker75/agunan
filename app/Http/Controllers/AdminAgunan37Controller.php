<?php namespace App\Http\Controllers;
	...
	use CRUDBooster;
	use PDF;
	class AdminAgunan37Controller extends \crocodicstudio\crudbooster\controllers\CBController {
        ...
        //nilai pasar
           ...
           $this->form[] = ['label' => 'Nilai Pasar', 'name' => 'nilai_pasar', 'type' => 'money', 'validation' => 'integer|min:0', 'width' => 'col-sm-10'];
                ...
                $this->form[] = ['label' => 'Nilai Margin', 'name' => 'nilai_margin', 'type' => 'number', 'validation' => 'integer|min:0', 'width' => 'col-sm-10'];
        ...
        $this->form[] = ['label' => 'Gambar Agunan', 'name' => 'agunan_image', 'type' => 'child', 'columns' => $columns, 'table' => 'agunan_image', 'foreign_key' => 'id_agunan'];
	        ...
	        */
	        $this->sub_module = array();
	         // $this->sub_module[] = ['label'=>'Pilih','path'=>'Assign Survey','button_color'=>'warning','button_icon'=>'fa fa-bars'];
