<?php namespace App\Http\Controllers;
	...
	class AdminUserKomiteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Role','name'=>'role','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10','value'=>'Komite'];
			...
			//$this->form[] = ["label"=>"Regid","name"=>"regid","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
