		...
		<div class="information">
			<table width="100%" >
				<tr>
					...
					<p style="font-size:18px;text-align: center;color: black;font-family:Arial">
						<b>Katalog Aset</b>
					</p></td>
				</tr>
				...
				<tr>
					...
					<table style="margin-left: 0px">
						<tbody>
							...
							<tr >
								@if($img1)
								<td style="padding:0;text-align: center"><img src="{{$image11}}" width="300px" height="240px"></td>
								@endif
							</tr>
							<tr >
								<!-- <td style="text-align: center!important;">MAP LOKASI</td> -->
								@if($img2)
								<td style="padding:0;text-align: center"><img src="{{$image22}}" width="300px" height="240px"></td>
								@endif
								<!-- <td style="text-align: center!important;">MAP LOKASI</td> -->
							</tr>
							@elseif($str1)
